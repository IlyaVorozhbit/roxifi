...
class GroupsMembersController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('GroupsMembers');
	 ...
	 * @return GroupsMembers the loaded model
	 ...
	 * @param GroupsMembers $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='groups-members-form')
		{
